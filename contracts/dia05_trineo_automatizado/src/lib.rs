...
impl TrineoContract {
    ...
    pub fn agregar_regalo(_env: Env, mut regalos: Vec<Symbol>, regalo: Symbol) -> Vec<Symbol> {
    ...
    pub fn contar_regalos(_env: Env, regalos: Vec<Symbol>) -> u32 {
    ...
    pub fn puede_despegar(_envv: Env, regalos: Vec<Symbol>) -> bool {
